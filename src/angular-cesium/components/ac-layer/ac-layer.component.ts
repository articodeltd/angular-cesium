...
@Component({
	...
	providers: [LayerService, ComputationCache, BillboardDrawerService, LabelDrawerService, StaticPolylineDrawerService]
})
export class AcLayerComponent implements OnInit, OnChanges, AfterContentInit {
	...
	constructor(private  layerService: LayerService,
		...
		this._drawerList.push(staticPolylineDrawerService);
	}
